...
def prepare_dataset():
    ...
    train_data, temp_data, train_decisions, temp_decisions = train_test_split(
        dataset, decisions, train_size=train_split, random_state=42, stratify=decisions)
    ...
    val_data, test_data, val_decisions, test_decisions = train_test_split(
        temp_data, temp_decisions, test_size=0.5, random_state=42, stratify=temp_decisions)
