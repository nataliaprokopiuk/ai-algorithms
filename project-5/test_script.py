...
def validate_model(model_path, activation_function, num_hidden_layers):
    ...
    # Load the model
    model = MLP(16, 100, 4, activation_function=activation_function, num_hidden_layers=num_hidden_layers)
...
if __name__ == "__main__":
    ...
    activation_function = activation_functions.get("leaky_relu", nn.LeakyReLU())
    validate_model("best_model_weights\LeakyReLU(negative_slope=0.01)_2_2024-06-04 08-01-16_bms.pth", activation_function, 2)
