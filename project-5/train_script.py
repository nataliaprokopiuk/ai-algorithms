...
def train_and_save_model(activation_function, num_hidden_layers):
    ...
    module = MLP(16, 100, 4, activation_function=activation_function, num_hidden_layers=num_hidden_layers)

    # Define the loss function and optimizer
    criterion = nn.CrossEntropyLoss()
    optimizer = optim.SGD(module.parameters(), lr=0.01, momentum=0.6, weight_decay=1e-4)
